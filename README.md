...
The API is deployed here: [ARTiza API](https://artiza-api.onrender.com)

And the deployed front-end is here: [ARTiza Frontend](https://artiza.vercel.app)
...
* To add the image processing capabilities that are needed in the project, run the command:
```
    pip install Pillow 
```
...
* In the settings.py file, set JSON Renderer if Dev environment is not present:
```
...
* In the Comment app, inside the serializers.py file, set the imports:
```
...
* Log in to [Supabase](https://supabase.com) to access your dashboard
* Click **New project**
* Give your project a name (commonly the name of the project)
* Choose a secure password without special characters and save it
* Select **North EU (Stockholm)** as your region
* Click **Create new project**
* Once created, click **Connect** and select **Session pooler** under **Connection String → URI**
* Copy the connection string and replace `[YOUR-PASSWORD]` with your password
...
Here is a link to my deployed project: [ARTiza API](https://artiza-api.onrender.com)
...
* In the env.py file, add your environment variables:
```
    import os
...
* Make sure env.py is added to .gitignore
...
Cloning the project means you are creating a local copy of the project on your own machine. This enables you to make changes without affecting the original repository.

Forking it means you are creating a copy of the project on your own GitHub account, which gives you the ability to propose changes to the original project, or just developing your own modified version of it.
...
I used a PostgreSQL database for this project, at [Supabase](https://supabase.com).
